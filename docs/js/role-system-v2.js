(function (root, factory) {
  ...
  const ROLE_PERMISSIONS = Object.freeze({
    ...
    LAYANAN_KEBERSIHAN: [...BASE_MENUS, "menu-dashboard-operasional", "menu-jurnal-pkl", "menu-buku-izin", "menu-buku-tamu", "menu-penitipan-barang"],
  ...
  function menusFor(roleId, scope) {
    ...
    if (roleId === 'SUPERVISOR') return [...BASE_MENUS,'menu-supervisor-v2','menu-supervisor-schedule','menu-kpi-supervisor',...(a.supervisedRoles.includes('KONSELOR')?['menu-arahan-kasus']:[]),...(canManageTahsinLevels(roleId,a)?['menu-penempatan-tahsin']:[])];
    if (roleId === 'MANAJER') {
