...
(() => {
  ...
  if(home || path==='wali/dashboard/beranda.html' || shell || path==='wali/dashboard/index.html'){
    ...
    if(home || path==='wali/dashboard/beranda.html'){
      const mobileScript=document.createElement('script');mobileScript.src=new URL('js/mobile-home-v2.js?v='+(path.startsWith('wali/')?'265':'266'),root).href;mobileScript.defer=true;document.head.append(mobileScript);
    }
  }
  const mappings = {
