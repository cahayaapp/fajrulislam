...
(() => {
  ...
  async function init(){
    ...
    if(!wali&&!window.CahayaRoleMenuV2){await new Promise((resolve,reject)=>{const script=document.createElement('script');script.src=new URL('js/role-menu-v2.js?v=271',root);script.onload=resolve;script.onerror=reject;document.head.append(script)})}
