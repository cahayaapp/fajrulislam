(function (root, factory) {
  ...
  const ROLE_PERMISSIONS = Object.freeze({
    ...
    MANAJER: [...BASE_MENUS, "menu-dashboard-operasional", "menu-kontrol-pendidikan", "menu-materi-pembelajaran", "menu-nilai-manajer", "menu-guru-pondok", "menu-kpi-guru", "menu-observasi-pembelajaran", "menu-riwayat-temuan", "menu-pembinaan-guru", "menu-absensi-ibadah-guru", "menu-pengaturan-guru-mukim", "menu-absensi-ibadah-naqib", "menu-tindak-akademik", "menu-kpi-manajer", "menu-penempatan-tahsin", "menu-kontrol-pembinaan", "menu-pantau-asesmen", "menu-jurnal-kesehatan", "menu-jurnal-sarpras", "menu-jurnal-pkl", "menu-media"],
  ...
  const SUPERVISOR_DIVISION_MENUS = Object.freeze({
    ...
    PEMBINAAN_KARAKTER: new Set(["menu-arahan-kasus", "menu-dashboard-operasional", "menu-review-pembinaan", "menu-kontrol-pembinaan", "menu-kpi-manajer", "menu-observer-pengasuhan", "menu-pantau-pendampingan", "menu-pantau-asesmen", "menu-jurnal-liburan-monitor", "menu-raport-sdm", "menu-tindak-lanjut-sdm"]),
  ...
  function menusFor(roleId, scope) {
    ...
    if (roleId === 'SUPERVISOR') return [...BASE_MENUS,'menu-supervisor-v2','menu-supervisor-schedule','menu-kpi-supervisor',...(a.supervisedRoles.includes('KONSELOR')?['menu-arahan-kasus']:[]),...(a.supervisedRoles.includes('DAPUR')?['menu-dapur-menu','menu-dapur-procurement-report']:[]),...((a.supervisedRoles||[]).some(item=>['NAQIB','NAQIBAH','MENTOR_USRAH'].includes(item))?['menu-jurnal-liburan-monitor']:[]),...(canManageTahsinLevels(roleId,a)?['menu-penempatan-tahsin','menu-review-pendidikan','menu-kontrol-publikasi-rapor']:[])];
    if (roleId === 'MANAJER') {
      if (isEducationManager(a)) return [...BASE_MENUS,'menu-kontrol-pendidikan','menu-materi-pembelajaran','menu-tindak-akademik','menu-absensi-ibadah-guru','menu-pengaturan-guru-mukim','menu-guru-pondok','menu-kpi-guru','menu-nilai-manajer','menu-observasi-pembelajaran','menu-riwayat-temuan','menu-pembinaan-guru','menu-kpi-manajer','menu-penempatan-tahsin'];
