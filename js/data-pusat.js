// ==========================================
// 🏥 CAHAYA APP - PUSAT DATA TUNGGAL
// ==========================================

// 1. DATA DEFAULT (Cadangan jika Memori Browser Kosong)
...
window.muatDataSantriPusat = function() {
    const savedData = localStorage.getItem('cahayaDataSantriCustom');
    if (savedData) {
        return JSON.parse(savedData);
    }
    return defaultDataSantri;
};

// 3. INISIALISASI VARIABEL GLOBAL
window.dataSantri = window.muatDataSantriPusat();

// 4. DATA GURU & MAPEL (Statis)
