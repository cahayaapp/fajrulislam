...
for (const label of ['Kontrol Hari Ini', 'Capaian Materi', 'Tindak Lanjut', 'Absensi Ibadah Guru Mukim', 'Pengaturan Guru Mukim', 'Guru Pondok', 'Progres Input Nilai', 'Observasi Pembelajaran', 'Riwayat Temuan', 'Pembinaan Guru', 'Panduan Kerja']) {
