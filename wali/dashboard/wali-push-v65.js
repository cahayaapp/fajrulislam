/* CAHAYA APP V65 — Push Notification Portal Wali */
(function(){
  'use strict';
  ...
  async function prepare(){
    ...
    state.registration=await navigator.serviceWorker.register('firebase-messaging-sw.js?v=65',{scope:'./'});
  ...
  async function registerToken(){
    ...
    localStorage.setItem('cahayaPushRegisteredV65',payload.updatedAt);
    return token;
  }
